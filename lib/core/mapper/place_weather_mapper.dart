...
CachedWeatherDto mapFromNetwork(
  ...
  return CachedWeatherDto(
    ...
    datetimeFormat.tryParse(networkResponse.daily?.time[1] ?? '')?.millisecondsSinceEpoch ?? 0,
    ...
    datetimeFormat.tryParse(networkResponse.daily?.time[2] ?? '')?.millisecondsSinceEpoch ?? 0,
    ...
    datetimeFormat.tryParse(networkResponse.daily?.time[3] ?? '')?.millisecondsSinceEpoch ?? 0,
    ...
    datetimeFormat.tryParse(networkResponse.daily?.time[4] ?? '')?.millisecondsSinceEpoch ?? 0,
