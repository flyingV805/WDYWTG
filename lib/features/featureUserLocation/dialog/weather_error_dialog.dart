...
class WeatherErrorDialog extends UserLocationDialog {
  ...
  void show(BuildContext blocContext) {
    ...
    showDialog(
      ...
      builder: (context){
        return AlertDialog(
          title: Text('Couldn\'t find weather in your location'),
          content: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text('There may be a problem with network access or weather provider.')
            ],
          ),
          actions: [
            TextButton(
